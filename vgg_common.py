...
def VGG19(include_top=True,
    ...
    # Block 1
    x,_,_ = layers.Conv2D(64, (3, 3),
                      activation='relu',
                      padding='same',
                      name='block1_conv1',
                      outputStaticInfo = True)(img_input)
    x,_,_ = layers.Conv2D(64, (3, 3),
                      activation='relu',
                      padding='same',
                      name='block1_conv2',
                      outputStaticInfo = True)(x)
    x = layers.MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool')(x)

    # Block 2
    x,_,_ = layers.Conv2D(128, (3, 3),
                      activation='relu',
                      padding='same',
                      name='block2_conv1',
                      outputStaticInfo = True)(x)
